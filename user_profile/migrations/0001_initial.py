    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=200)),
                ('cgpa_range', models.CharField(blank=True, max_length=200)),
                ('dept', models.CharField(blank=True, max_length=200)),
                ('core_courses', djongo.models.fields.ArrayField(blank=True, model_container=user_profile.models.CollegeCourse)),
                ('additional_courses', djongo.models.fields.ArrayField(blank=True, model_container=user_profile.models.CollegeCourse)),
            ],
        ),
        migrations.CreateModel(
            name='CollegeCourse',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nature', models.CharField(blank=True, max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('school', djongo.models.fields.EmbeddedField(blank=True, model_container=user_profile.models.School, null=True)),
                ('college', djongo.models.fields.EmbeddedField(blank=True, model_container=user_profile.models.College, null=True)),
                ('projects', djongo.models.fields.ArrayField(blank=True, model_container=user_profile.models.Project)),
                ('research_papers', djongo.models.fields.ArrayField(blank=True, model_container=user_profile.models.ResearchPaper)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_type', models.CharField(blank=True, max_length=10)),
