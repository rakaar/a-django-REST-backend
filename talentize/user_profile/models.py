...
class Project(models.Model):
    ...
    project_type = models.CharField(max_length=10) #prof / FTP / BTP,MTP / self
    associated_info = models.CharField(max_length=20, blank=True) # prof_name / college_name / prof_name / null
